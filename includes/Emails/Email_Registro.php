				...
				<table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;font-family: Arial, sans-serif;">
					<tr>
						<td colspan="4" valign="top" class="image-section" style="border-collapse: collapse;border: 0;margin: 0;padding: 0;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;background-color: #fff;border-bottom: 4px solid #156E12">
							<a href="https://tenable.com"><img class="top-image" src="" style="line-height: 1;width: 600px;" alt="Tenable Network Security"></a>
						</td>
					</tr>
					<tr>
						<td valign="top" class="side title" style="border-collapse: collapse;border: 0;margin: 0;padding: 20px;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;vertical-align: top;background-color: white;border-top: none;">
							<table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;font-family: Arial, sans-serif;">
								...
								<!--<tr>
									<img src="https://i.ibb.co/fFnLzPw/img1.png" alt="imag1" border="0"></a>
								</tr>-->
								<tr>
									...
									<div class="mktEditable" id="main_text">
										...
										Acabas de registrarte en Ya le pondre nombre a la app
										Para verificar su cuenta, por favor haga en el siguiente botón.<br><br>
										
										Si usted no realizó dicho registro, por favor, ignore este mensaje.
									</div>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<div class="mktEditable" id="download_button" style="text-align: center;">
										<a href="https://proyectocarpeta.000webhostapp.com/?Token=<?php echo $activacion; ?>">
									
										<button style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px;">Confirmar registro</button>
									</a>
									</div>
									</td>
								</tr>
							...
							<table>
								<tr>
									<td align="center" style="font-family: Arial, sans-serif; -webkit-text-size-adjust: none; font-size: 16px;">
											...
											<br/><span style="font-size:12x; font-family: Arial, sans-serif; -webkit-text-size-adjust: none; color: #61955B;" >En caso de que el botón no funcione, copie y pegue el siguiente enlace en su navegador: </br>https://proyectocarpeta.000webhostapp.com/?Token=<?php echo $activacion; ?></span>
							...
							<table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;font-family: Arial, sans-serif;">
								<tr>
									<td align="center" valign="middle" class="social" style="border-collapse: collapse;border: 0;margin: 0;padding: 10px;-webkit-text-size-adjust: none;color: #49CB44;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;text-align: center;">
										<table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;font-family: Arial, sans-serif;">
											<tr>
									<td style="border-collapse: collapse;border: 0;margin: 0;padding: 5px;-webkit-text-size-adjust: none;color: #49CB44;font-family: Arial, sans-serif;font-size: 16px;line-height: 26px;"><a href=""><img src="https://info.tenable.com/rs/tenable/images/facebook-teal.png"></a></td>
											</tr>
										</table>
									</td>
								</tr>
...
<div id="address" class="mktEditable">
										<b>Ya le pondre nombre a la app</b>
</div>
									</td>
								</tr>
							</table>
